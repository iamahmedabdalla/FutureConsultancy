    ...
    <div className='w-full bg-white py-16 px-4' id='services'>
      <div className='max-w-[1240px] mx-auto'>
        <div className='flex flex-col md:flex-row justify-center items-center p-4'>
          <h1 className='text-3xl font-bold text-[#000000] mb-4 md:mb-0 items-center'>
            Services <span className='text-[#00df9a]'>We Offer</span>
          ...
          '>
            ...
            <div className=' border-2 border-[#5dffb9] rounded-md p-4
            md:w-1/2 md:h-1/2
            sm:w-1/2 sm:h-1/2
            xs:w-full xs:h-full
            xl:w-1/2 xl:h-1/2
            w-full h-full
            bg-[#5dffb9] text-white
            '>
              ...
              <button className=' bg-[#000000] rounded-md font-medium my-6 mx-auto py-3 text-white px-4 md:px-8 hover:text-white hover:bg-[#2e7aff] transition duration-500 ease-in-out '> Learn More </button>
