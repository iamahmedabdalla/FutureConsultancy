...
const Reasons = () => {
  return (
    <div className='flex flex-col justify-center items-center bg-[#000300] text-white py-20' id='why_us' >
      <h1 className='text-4xl font-bold'>Why Choose <span className='text-[#00df9a]'>US?</span>
      </h1>
      <div className='flex flex-col md:flex-row justify-center items-center mt-10'>
        <div className='flex flex-col justify-center items-center p-4'>
          <div className='bg-[#5dffb9] rounded-full p-4'>
            <FaPlus size={40} color='#000300' />
          </div>
        ...
        <div className='flex flex-col justify-center items-center p-4'>
          <div className='bg-[#5dffb9] rounded-full p-4'>
            < FaFireAlt size={40} color='#000300' />
          </div>
        ...
        <div className='flex flex-col justify-center items-center p-4'>
          <div className='bg-[#5dffb9] rounded-full p-4'>
            <FaBusinessTime size={40} color='#000300' />
          </div>
        ...
        <div className='flex flex-col justify-center items-center p-4'>
          <div className='bg-[#5dffb9] rounded-full p-4'>
            <FaRegHandshake size={40} color='#000300' />
          </div>
      ...
      <button className='
        bg-[#fff52e] rounded-md font-medium my-6 mx-auto py-3 text-black px-10
       md:px-8
