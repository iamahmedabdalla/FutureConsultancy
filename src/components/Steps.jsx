...
const Steps = () => {
  return (
    <div className='flex flex-col items-center justify-center text-black bg-[#ffffff] py-20 px-5' id='steps'>
        <h1 className='text-3xl text-[#763C00] font-bold'>Five Easy <span className='text-[#763C00]'>Steps</span></h1>
        <div className='flex flex-col md:flex-row items-center justify-center mt-10'>
            <div className='flex flex-col items-center justify-center text-[#763C00]'>
                <div className='bg-[#FFCB65] rounded-full w-20 h-20 flex items-center justify-center'>
            ...
            <div className='flex flex-col items-center text-[#763C00] justify-center mt-10 md:mt-0'>
                <div className='bg-[#FFCB65] rounded-full w-20 h-20 flex items-center justify-center'>
                    <h1 className='text-3xl font-bold'>2</h1>
                </div>
                <h1 className='text-lg font-bold mt-4 text-[#763C00]'>Get your documents ready</h1>
                <p className='text-center mt-4'>
            ...
            <div className='flex flex-col items-center text-[#763C00] justify-center mt-10 md:mt-0'>
                ...
                <p className='text-center mt-4 text-[#763C00]'>
            ...
            <div className='flex flex-col items-center justify-center text-[#763C00] mt-10 md:mt-0'>
                <div className='bg-[#FFCB65] rounded-full w-20 h-20 flex items-center justify-center'>
